...
function Navbar() {
  ...
  return (
    <div className="w-64 h-screen fixed top-0 left-0 border-r border-gray-700 p-6 flex flex-col space-y-6 bg-black text-white pt-10 justify-between">
      <div>
        <svg
          aria-label="Instagram"
          className="x1lliihq x1n2onr6 x5n08af text-2xl font-bold mb-10"
          fill="currentColor"
          height="29"
          role="img"
          viewBox="32 4 113 32"
        ...
        <nav className="flex flex-col space-y-7 text-lg">
          ...
          <NavLink to="/search" className={linkClasses}>
            {({ isActive }) => (
              <>
                <FiSearch className="text-2xl" style={iconStyle(isActive)} />
                <span>Recherche</span>
              </>
            )}
          </NavLink>
          ...
          <NavLink to="/notifications" className={linkClasses}>
            {({ isActive }) => (
              <>
                <FaRegHeart className="text-2xl" style={iconStyle(isActive)} />
