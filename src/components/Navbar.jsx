...
function Navbar() {
  ...
  return (
    <>
      ...
      <div
        className={[
          "hidden md:flex md:flex-col md:h-screen md:fixed md:top-0 md:left-0 md:border-r border-gray-800 md:pt-10 md:pb-10 md:bg-black md:text-white md:justify-between z-40",
          "md:w-[72px]",
      ...
      >
        ...
        <div>
          <div
            className={[
              ...
              overlayOpen
                ...
                : "xl:flex xl:justify-start xl:ml-4",
              "transition-all duration-300 ease-in-out",
            ].join(" ")}
          >
            {/* Logo étendu (xl) */}
          ...
          <nav
            className={[
              "flex flex-col space-y-8 text-md",
              "md:items-center",
              overlayOpen ? "xl:items-center" : "xl:items-start xl:pl-5",
              "transition-all duration-300 ease-in-out",
            ].join(" ")}
          >
            {/* Accueil */}
            ...
            <button
              ...
              onMouseDown={(e) => {
                e.preventDefault();
                e.stopPropagation();
                // Si déjà ouvert, on ferme. Sinon, on ouvre en exclusif.
                if (isSearchOpen) {
                  setSearchOpen(false);
                } else {
